...
| **[Heartbeat Anomaly Detector](https://huggingface.co/ai-mitra/heartbeat-anomaly-detector)** | CNN detecting heart-sound abnormalities from phonocardiograms, paired with rule-based clinical reasoning — published on 🤗 | PyTorch · BioSPPy |
